...
Namespace ChangeEditMask.Win
    ...
    Public Partial Class ChangeEditMaskWindowsFormsApplication
        ...
        Private Sub ChangeEditMaskWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub ChangeEditMaskWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
            e.Updater.Update();
            e.Handled = true;
#Else
